...
The combination of cryptography, free libre software and a data network make it possible the appearance of networked cryptocurrencies.
...
In fact, the money generation business (popularly known as \emph{mining}) is a risky endeavour as the cost of hashing power can exceed the value of the generated money.
...
The gift (or reputation) economy is the kind of economy we find on the Internet, in which the participants offer software, articles, music, pictures and all kind of digital goods for free using permissive licenses such as Creative Commons.
...
The invention of information processing and transmission tools favors community-centric models.
...
The first example of successes can be found precisely in the fields of information and communication technologies.
...
Another example of the successful application of the community-centric model is the free libre opens source movement.
Thousands of programmers affiliate to and contribute to this movement working as self-managed community.
The goods offered by this community often outperform those that have been developed using hierarchical models.
...
Both Arduino and Raspberry-Pi are open hardware projects that are aligned with community-centric innovation.
