...
The Internet is a disruptive innovation that is completely transforming the way we organize ourselves and relate to each other.
...
Filtering the information and ordering Internet blackouts have been used as ways for hindering social movements and placate population unrest. 
...
The dynamic routing protocols, such as BMX6, allow the network to quickly re-configure itself and route packets around failures to keep connectivity.
...
This continuous change that forces to keep the equipment firmware updated represents  an additional layer of protection against spying agencies interested in compromising the network.
...
The lack of a central authority obliges the participants to take responsibility, exercise their freedom respecting the others and making concessions in order to achieve common goals.
