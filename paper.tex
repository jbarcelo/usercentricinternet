...
Mesh routing protocols, such as BMX6, allow the network to quickly re-configure itself and route packets around failures to keep connectivity.
...
It is much more difficult to attack up-to-date system than it is to attack systems running old unpatched firmwares.
